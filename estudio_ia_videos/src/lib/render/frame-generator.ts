...
// IMPORTANT: Do NOT import @remotion packages at top level
// They trigger Chromium downloads during build, causing hangs
// If needed, use dynamic imports: await import('@remotion/renderer')
