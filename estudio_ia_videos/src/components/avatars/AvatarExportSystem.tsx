...
export default function AvatarExportSystem({ 
  ...
  const platformPresets = {
    youtube: {
      video: { format: 'mp4' as const, resolution: '1080p' as const, fps: 30 as const, bitrate: 8000, codec: 'h264' as const },
      audio: { enabled: true, format: 'aac' as const, bitrate: 128 },
      rendering: { quality: 'high' as const },
      platform: { optimizeFor: 'web' as const }
    },
    instagram: {
      video: { format: 'mp4' as const, resolution: '1080p' as const, fps: 30 as const, bitrate: 3500, codec: 'h264' as const },
      audio: { enabled: true, format: 'aac' as const, bitrate: 128 },
      rendering: { quality: 'standard' as const },
      platform: { optimizeFor: 'mobile' as const }
    },
    tiktok: {
      video: { format: 'mp4' as const, resolution: '1080p' as const, fps: 30 as const, bitrate: 2500, codec: 'h264' as const },
      audio: { enabled: true, format: 'aac' as const, bitrate: 96 },
      rendering: { quality: 'standard' as const },
      platform: { optimizeFor: 'mobile' as const }
    },
    linkedin: {
      video: { format: 'mp4' as const, resolution: '720p' as const, fps: 30 as const, bitrate: 2000, codec: 'h264' as const },
      audio: { enabled: true, format: 'aac' as const, bitrate: 128 },
      rendering: { quality: 'standard' as const },
      platform: { optimizeFor: 'web' as const }
    },
    ...
    facebook: {
      video: { format: 'mp4' as const, resolution: '1080p' as const, fps: 30 as const, bitrate: 4000, codec: 'h264' as const },
      audio: { enabled: true, format: 'aac' as const, bitrate: 128 },
      rendering: { quality: 'high' as const },
      platform: { optimizeFor: 'web' as const }
    }
