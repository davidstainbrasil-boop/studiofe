...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e60]:
        - generic [ref=e61]:
          - heading "Login Rápido (Dev Only)" [level=3] [ref=e62]:
            - img [ref=e63]
            - text: Login Rápido (Dev Only)
          - paragraph [ref=e65]: Clique para logar instantaneamente como um usuário de teste
        - generic [ref=e67]:
          - button "Admin" [ref=e68] [cursor=pointer]:
            - img [ref=e69]
            - generic [ref=e71]: Admin
          - button "Editor" [ref=e72] [cursor=pointer]:
            - img [ref=e73]
            - generic [ref=e76]: Editor
          - button "Viewer" [ref=e77] [cursor=pointer]:
            - img [ref=e78]
            - generic [ref=e81]: Viewer
